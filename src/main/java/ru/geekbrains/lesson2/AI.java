...
Добавлен искусственный интеллект, частично блокирующий ходы игрока, и даже предпринимающий попытки нападения. Для реализации данной задачи разработаны следующие алгоритмы:
Алгоритм "Шах и мат" - обнаруживает комбинацию из символов AI расположенных в ряд друг за другом в количестве достаточном для выигрыша в один ход и выполняет победный ход.
Алгоритм "Палка о двух концах" обнаруживает опасность поражения в 2 хода и пытается блокировать ее.
Алгоритм "Прилипала" навязывает свою игру, выполняя очередной ход в непосредственной близости от хода противника, выбирая наиболее выгодную позицию.
Дополнительно реализован механизм подсчета потенциала или баланса сил в клетке хода, для принятия решения о ходе при наличии нескольких вариантов.**/
